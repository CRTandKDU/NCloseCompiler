...
/** @brief @b Interpreter Working Memory persistence in CouchDB datastore */
class CouchWorkingMemory : public WorkingMemory {
public:
  ...
  /** Constructors */
  CouchWorkingMemory();
  CouchWorkingMemory( std::string URL, std::string DB, std::string DOC );
  /** Destructor */
  ~CouchWorkingMemory();
