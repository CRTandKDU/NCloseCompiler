...
class CouchMemory: public CouchExtWorkingMemory {
public:
  /** Constructors */
  CouchMemory() : CouchExtWorkingMemory(){};
  CouchMemory( std::string URL, std::string DB, std::string DOC ):
    CouchExtWorkingMemory(  URL,  DB,  DOC ){};
  /** Destructor */
  ~CouchMemory(){};
  ...
  void getAgenda( CouchExtAgenda *agenda );
  /** Updates Couch document with current agenda */
  void setAgenda( CouchExtAgenda *agenda );
